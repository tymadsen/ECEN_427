...
#
#  File     top_level_ports_wave.tcl (Fri Nov 20 16:10:08 2015)
#
...
wave add $tbpath${ps}nes_controller_0_LEDs_pin -into $id 
wave add $tbpath${ps}nes_controller_0_C1_PULSE_pin -into $id 
wave add $tbpath${ps}nes_controller_0_C1_LATCH_pin -into $id 
wave add $tbpath${ps}nes_controller_0_C1_DATA_pin -into $id 
wave add $tbpath${ps}nes_controller_0_C2_PULSE_pin -into $id 
wave add $tbpath${ps}nes_controller_0_C2_LATCH_pin -into $id 
wave add $tbpath${ps}nes_controller_0_C2_DATA_pin -into $id 
